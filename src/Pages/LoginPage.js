        ...
        <div>
            ...
            <div className='d-flex justify-content-center' style={{alignItems:'center'}}>
                <Form style={{width : '400px', height: '205px'}}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-around', marginTop:'20px', fontSize:'15px'}}>
                        <Link to='/register'>
                            Don't have an account? Register here
                        </Link>
                    </div>
                    <div style={{display: 'flex', justifyContent: 'space-around', marginTop:'20px', fontSize:'20px',}}>
                        <Link to='/'>
